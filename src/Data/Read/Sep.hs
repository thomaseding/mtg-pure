...
instance (LitSymbol s, Read a) => Read (List s a) where
  readsPrec :: (LitSymbol s, Read a) => Int -> ReadS (List s a)
  readsPrec _ s = [(List $ map read $ sep @s s, "")]

instance (LitSymbol s, Show a) => Show (List s a) where
  show :: (LitSymbol s, Show a) => List s a -> String
...
instance (Inst1 Eq a) => Eq (Tuple s (a, ())) where
  (==) :: (Inst1 Eq a) => Tuple s (a, ()) -> Tuple s (a, ()) -> Bool
  (==) = \case
    Tuple1 a1 -> \case
      Tuple1 a2 ->
        a1 == a2
...
instance (Inst2 Eq a b) => Eq (Tuple s (a, b, ())) where
  (==) :: (Inst2 Eq a b) => Tuple s (a, b, ()) -> Tuple s (a, b, ()) -> Bool
  (==) = \case
    Tuple2 a1 b1 -> \case
      Tuple2 a2 b2 ->
        a1 == a2 && b1 == b2
...
instance (Inst3 Eq a b c) => Eq (Tuple s (a, b, c, ())) where
  (==) :: (Inst3 Eq a b c) => Tuple s (a, b, c, ()) -> Tuple s (a, b, c, ()) -> Bool
  (==) = \case
...
instance (Inst4 Eq a b c d) => Eq (Tuple s (a, b, c, d, ())) where
  (==) :: (Inst4 Eq a b c d) => Tuple s (a, b, c, d, ()) -> Tuple s (a, b, c, d, ()) -> Bool
  (==) = \case
...
instance (Inst5 Eq a b c d e) => Eq (Tuple s (a, b, c, d, e, ())) where
  (==) :: (Inst5 Eq a b c d e) => Tuple s (a, b, c, d, e, ()) -> Tuple s (a, b, c, d, e, ()) -> Bool
  (==) = \case
...
instance (Inst1 Ord a) => Ord (Tuple s (a, ())) where
  compare :: (Inst1 Ord a) => Tuple s (a, ()) -> Tuple s (a, ()) -> Ordering
  compare = \case
    Tuple1 a1 -> \case
      Tuple1 a2 ->
        compare a1 a2
...
instance (Inst2 Ord a b) => Ord (Tuple s (a, b, ())) where
  compare :: (Inst2 Ord a b) => Tuple s (a, b, ()) -> Tuple s (a, b, ()) -> Ordering
  compare = \case
    Tuple2 a1 b1 -> \case
      Tuple2 a2 b2 ->
...
instance (Inst3 Ord a b c) => Ord (Tuple s (a, b, c, ())) where
  compare :: (Inst3 Ord a b c) => Tuple s (a, b, c, ()) -> Tuple s (a, b, c, ()) -> Ordering
  compare = \case
    Tuple3 a1 b1 c1 -> \case
      Tuple3 a2 b2 c2 ->
...
instance (Inst4 Ord a b c d) => Ord (Tuple s (a, b, c, d, ())) where
  compare :: (Inst4 Ord a b c d) => Tuple s (a, b, c, d, ()) -> Tuple s (a, b, c, d, ()) -> Ordering
  compare = \case
    Tuple4 a1 b1 c1 d1 -> \case
      Tuple4 a2 b2 c2 d2 ->
...
instance (Inst5 Ord a b c d e) => Ord (Tuple s (a, b, c, d, e, ())) where
  compare :: (Inst5 Ord a b c d e) => Tuple s (a, b, c, d, e, ()) -> Tuple s (a, b, c, d, e, ()) -> Ordering
  compare = \case
    Tuple5 a1 b1 c1 d1 e1 -> \case
      Tuple5 a2 b2 c2 d2 e2 ->
...
instance (Inst2 Read a b, LitSymbol s) => Read (Tuple s (a, b, ())) where
  readsPrec :: (Inst2 Read a b, LitSymbol s) => Int -> ReadS (Tuple s (a, b, ()))
  readsPrec _ s = case sep @s s of
...
instance (Inst3 Read a b c, LitSymbol s) => Read (Tuple s (a, b, c, ())) where
  readsPrec :: (Inst3 Read a b c, LitSymbol s) => Int -> ReadS (Tuple s (a, b, c, ()))
  readsPrec _ s = case sep @s s of
...
instance (Inst4 Read a b c d, LitSymbol s) => Read (Tuple s (a, b, c, d, ())) where
  readsPrec :: (Inst4 Read a b c d, LitSymbol s) => Int -> ReadS (Tuple s (a, b, c, d, ()))
  readsPrec _ s = case sep @s s of
...
instance (Inst5 Read a b c d e, LitSymbol s) => Read (Tuple s (a, b, c, d, e, ())) where
  readsPrec :: (Inst5 Read a b c d e, LitSymbol s) => Int -> ReadS (Tuple s (a, b, c, d, e, ()))
  readsPrec _ s = case sep @s s of
...
instance (Inst2 Eq a z) => Eq (TupleList s (a, ()) z) where
  (==) :: (Inst2 Eq a z) => TupleList s (a, ()) z -> TupleList s (a, ()) z -> Bool
  (==) = \case
...
instance (Inst3 Eq a b z) => Eq (TupleList s (a, b, ()) z) where
  (==) :: (Inst3 Eq a b z) => TupleList s (a, b, ()) z -> TupleList s (a, b, ()) z -> Bool
  (==) = \case
...
instance (Inst4 Eq a b c z) => Eq (TupleList s (a, b, c, ()) z) where
  (==) :: (Inst4 Eq a b c z) => TupleList s (a, b, c, ()) z -> TupleList s (a, b, c, ()) z -> Bool
  (==) = \case
...
instance (Inst5 Eq a b c d z) => Eq (TupleList s (a, b, c, d, ()) z) where
  (==) :: (Inst5 Eq a b c d z) => TupleList s (a, b, c, d, ()) z -> TupleList s (a, b, c, d, ()) z -> Bool
  (==) = \case
...
instance (Inst6 Eq a b c d e z) => Eq (TupleList s (a, b, c, d, e, ()) z) where
  (==) :: (Inst6 Eq a b c d e z) => TupleList s (a, b, c, d, e, ()) z -> TupleList s (a, b, c, d, e, ()) z -> Bool
  (==) = \case
...
instance (Inst2 Ord a z) => Ord (TupleList s (a, ()) z) where
  compare :: (Inst2 Ord a z) => TupleList s (a, ()) z -> TupleList s (a, ()) z -> Ordering
  compare = \case
    TupleList1 a1 zs1 -> \case
      TupleList1 a2 zs2 ->
...
instance (Inst3 Ord a b z) => Ord (TupleList s (a, b, ()) z) where
  compare :: (Inst3 Ord a b z) => TupleList s (a, b, ()) z -> TupleList s (a, b, ()) z -> Ordering
  compare = \case
    TupleList2 a1 b1 zs1 -> \case
      TupleList2 a2 b2 zs2 ->
...
instance (Inst4 Ord a b c z) => Ord (TupleList s (a, b, c, ()) z) where
  compare :: (Inst4 Ord a b c z) => TupleList s (a, b, c, ()) z -> TupleList s (a, b, c, ()) z -> Ordering
  compare = \case
    TupleList3 a1 b1 c1 zs1 -> \case
      TupleList3 a2 b2 c2 zs2 ->
...
instance (Inst5 Ord a b c d z) => Ord (TupleList s (a, b, c, d, ()) z) where
  compare :: (Inst5 Ord a b c d z) => TupleList s (a, b, c, d, ()) z -> TupleList s (a, b, c, d, ()) z -> Ordering
  compare = \case
    TupleList4 a1 b1 c1 d1 zs1 -> \case
      TupleList4 a2 b2 c2 d2 zs2 ->
...
instance (Inst6 Ord a b c d e z) => Ord (TupleList s (a, b, c, d, e, ()) z) where
  compare :: (Inst6 Ord a b c d e z) => TupleList s (a, b, c, d, e, ()) z -> TupleList s (a, b, c, d, e, ()) z -> Ordering
  compare = \case
    TupleList5 a1 b1 c1 d1 e1 zs1 -> \case
      TupleList5 a2 b2 c2 d2 e2 zs2 ->
...
instance (Inst5 Show a b c d z) => Show (TupleList s (a, b, c, d, ()) z) where
  show :: (Inst5 Show a b c d z) => TupleList s (a, b, c, d, ()) z -> String
  show = \case
...
instance (Inst6 Show a b c d e z) => Show (TupleList s (a, b, c, d, e, ()) z) where
  show :: (Inst6 Show a b c d e z) => TupleList s (a, b, c, d, e, ()) z -> String
  show = \case
...
instance (Inst2 Read a z, LitSymbol s) => Read (TupleList s (a, ()) z) where
  readsPrec :: (Inst2 Read a z, LitSymbol s) => Int -> ReadS (TupleList s (a, ()) z)
  readsPrec _ s = case sep @s s of
...
instance (Inst3 Read a b z, LitSymbol s) => Read (TupleList s (a, b, ()) z) where
  readsPrec :: (Inst3 Read a b z, LitSymbol s) => Int -> ReadS (TupleList s (a, b, ()) z)
  readsPrec _ s = case sep @s s of
...
instance (Inst4 Read a b c z, LitSymbol s) => Read (TupleList s (a, b, c, ()) z) where
  readsPrec :: (Inst4 Read a b c z, LitSymbol s) => Int -> ReadS (TupleList s (a, b, c, ()) z)
  readsPrec _ s = case sep @s s of
...
instance (Inst5 Read a b c d z, LitSymbol s) => Read (TupleList s (a, b, c, d, ()) z) where
  readsPrec :: (Inst5 Read a b c d z, LitSymbol s) => Int -> ReadS (TupleList s (a, b, c, d, ()) z)
  readsPrec _ s = case sep @s s of
...
instance (Inst6 Read a b c d e z, LitSymbol s) => Read (TupleList s (a, b, c, d, e, ()) z) where
  readsPrec :: (Inst6 Read a b c d e z, LitSymbol s) => Int -> ReadS (TupleList s (a, b, c, d, e, ()) z)
  readsPrec _ s = case sep @s s of
