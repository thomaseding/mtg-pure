...
replayInputs =
  ...
  , "ActivateAbility 138 R # O=1 PreCombatMainPhase Turn1"
  ...
  , "141 # Attack ; O=1 DeclareAttackersStep Turn1"
  ...
  , "ActivateAbility 144 R # O=2 PreCombatMainPhase Turn2"
  ...
  , "147 # Attack ; O=2 DeclareAttackersStep Turn2"
  ...
  , "147 # Attack ; O=2 DeclareAttackersStep Turn4"
  , "Pass # O=2 DeclareAttackersStep Turn4"
  , "Pass # O=1 DeclareAttackersStep Turn4"
  , "147 141 # Block ; O=1 DeclareBlockersStep Turn4"
